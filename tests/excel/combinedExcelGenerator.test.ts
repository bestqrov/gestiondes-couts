...
describe('generateCombinedExcel', () => {
  ...
  it('writes a single .xlsx file containing only the Articles summary and a combined Global sheet', async () => {
    ...
    expect(globalSheet.getRow(3).getCell(5).value).toBe('N° Enregistrement');
    expect(globalSheet.getRow(3).getCell(6).value).toBe('HSC');
    ...
    expect(globalSheet.getRow(4).getCell(5).value).toBe('0076481 X 25/06/2026');
    ...
    expect(globalSheet.getRow(557).getCell(5).value).toBe('0076481 X 25/06/2026');
    ...
    expect(globalSheet.getRow(4).getCell(7).value).toBe(1); // article 1, serial 1
    expect(globalSheet.getRow(357).getCell(7).value).toBe(354); // article 1, serial 354 (last row)
    expect(globalSheet.getRow(358).getCell(7).value).toBe(1); // article 2, serial 1 (first row after article 1)
    expect(globalSheet.getRow(557).getCell(7).value).toBe(200); // article 2, serial 200 (last row)
